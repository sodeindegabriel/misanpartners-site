  ...
  async function checkFileAccess(btn){
    ...
    try {
      ...
      if (status === 'approved'){
        ...
        btn.style.pointerEvents = 'none';
        btn.innerHTML = 'Access Declined · <a href="mailto:c@misanpartners.com" style="color:rgba(255,255,255,0.5);text-decoration:underline;pointer-events:auto;">contact us</a>';
      }
